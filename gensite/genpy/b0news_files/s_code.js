...
/*
/* Version: 3.8.10
/* Last modified by tech@dmpg.co.uk
/* Last modified 30/12/2013  //DD/MM/YYYY
/* 
 */
	//Identify Language service name
 	if ("undefined" != typeof ws &&
		...
		if (ws.siteCatalyst.service == 'china') {ws.siteCatalyst.service = 'ukchina'}else 
		if (ws.siteCatalyst.service.match('cojo')){ ws.siteCatalyst.service = 'other';}else 
		if (ws.siteCatalyst.service == 'english'){ ws.siteCatalyst.service = 'worldservice'}else 
		if (ws.siteCatalyst.service == 'french'){ ws.siteCatalyst.service = 'afrique'}else 
		if (ws.siteCatalyst.service == 'gahuza'){ ws.siteCatalyst.service = 'greatlakes'}else 
		if (ws.siteCatalyst.service == 'great_lakes'){ ws.siteCatalyst.service = 'greatlakes'}else 	
		if (ws.siteCatalyst.service == 'indonesia'){ ws.siteCatalyst.service = 'indonesian'}else 
		if (ws.siteCatalyst.service == 'myanmar'){ ws.siteCatalyst.service = 'burmese'}else 
		if (ws.siteCatalyst.service == 'russian_liveplanet'){ ws.siteCatalyst.service = 'russian'}else 		
		if (ws.siteCatalyst.service == 'russiannet'){ ws.siteCatalyst.service = 'russian'}else 
		if (ws.siteCatalyst.service == 'tajik'){ ws.siteCatalyst.service = 'persian'}else 
		if (ws.siteCatalyst.service == 'turkce'){ ws.siteCatalyst.service = 'turkish'}else 
		if (ws.siteCatalyst.uri.match('ukchina/simp')){ ws.siteCatalyst.service = 'ukchina'}else 
		if (ws.siteCatalyst.uri.match('ukchina/trad')){ ws.siteCatalyst.service = 'ukchina'}else 
		if (ws.siteCatalyst.uri.match('worldservice_1024')){ ws.siteCatalyst.service = 'worldservice'}else 
		if (ws.siteCatalyst.service == 'zhongwen/trad'){ ws.siteCatalyst.service = 'chinese'}else 
		if (ws.siteCatalyst.uri.match('zhongwen/trad')){ ws.siteCatalyst.service = 'chinese'}else 
		if (ws.siteCatalyst.service == 'zhongwen/simp'){ ws.siteCatalyst.service = 'chinese'}else 
		if (ws.siteCatalyst.uri.match('zhongwen/simp')){ ws.siteCatalyst.service = 'chinese'}else 
		if (ws.siteCatalyst.service == 'zhongwen'){ ws.siteCatalyst.service = 'chinese'}

		//Set Report Suites for Learning English sub-sites		
		if (ws.siteCatalyst.uri.match('ukchina/simp/elt')){ ws.siteCatalyst.service = 'ukchina,bbclearningenglish'}else 
		if (ws.siteCatalyst.uri.match('hindi/learningenglish')){ ws.siteCatalyst.service = 'hindi,bbclearningenglish'}else 
		if (ws.siteCatalyst.uri.match('persian/learningenglish')){ ws.siteCatalyst.service = 'persian,bbclearningenglish'}else 
		if (ws.siteCatalyst.uri.match('turkce/ingilizce_dersleri')){ ws.siteCatalyst.service = 'turkish,bbclearningenglish'}else 
		if (ws.siteCatalyst.uri.match('ukrainian/learning_english')){ ws.siteCatalyst.service = 'ukrainian,bbclearningenglish'}else 
		if (ws.siteCatalyst.uri.match('uzbek/learningenglish')){ ws.siteCatalyst.service = 'uzbek,bbclearningenglish'}else 
		if (ws.siteCatalyst.uri.match('burmese/news/learning_talking_sports.shtml')){ ws.siteCatalyst.service = 'burmese,bbclearningenglish'}else 
		if (ws.siteCatalyst.uri.match('french/highlights/cluster/2008/03/080321_english_by_radio.shtml')){ ws.siteCatalyst.service = 'afrique,bbclearningenglish'}else 
		if (ws.siteCatalyst.uri.match('albanian/learningenglish')){ ws.siteCatalyst.service = 'wsother,bbclearningenglish'}else 
		if (ws.siteCatalyst.uri.match('czech/learningenglish')){ ws.siteCatalyst.service = 'wsother,bbclearningenglish'}else 
		if (ws.siteCatalyst.uri.match('polish/englishgrammar')){ ws.siteCatalyst.service = 'wsother,bbclearningenglish'}else 
		if (ws.siteCatalyst.uri.match('polish/everydayenglish')){ ws.siteCatalyst.service = 'wsother,bbclearningenglish'}else 
		if (ws.siteCatalyst.uri.match('polish/businessenglish')){ ws.siteCatalyst.service = 'wsother,bbclearningenglish'}else 
		if (ws.siteCatalyst.uri.match('serbian/learningenglish')){ ws.siteCatalyst.service = 'wsother,bbclearningenglish'}else 
		...
		if (suiteServiceName == "portuguese"){ suiteServiceName = "portuguesebrazil"}else
		if (suiteServiceName == "portugueseafrica"){ suiteServiceName = "wsother"}else
		if (suiteServiceName == "albanian"){suiteServiceName = "wsother"}else
		if (suiteServiceName == "caribbean"){suiteServiceName = "wsother"}else
		if (suiteServiceName == "macedonian"){suiteServiceName = "wsother"}else
		if (suiteServiceName == "nazer"){suiteServiceName = "wsother"}else 
		if (suiteServiceName == "serbian"){suiteServiceName = "wsother"};		

		}
		
		//Set name of reporting suite for World Service /programmes & /worldserviceradio pages
		if (window.location.pathname.match(/\/programmes/i)) suiteServiceName = 'worldservice';
		if (window.location.pathname.match(/\/worldserviceradio/i)) suiteServiceName = 'worldservice';
...
var search = /\./g; 
for(s.cookieDomainPeriods=0; search.exec(document.domain); ++s.cookieDomainPeriods); 
s.fpCookieDomainPeriods=s.cookieDomainPeriods; 

try{
	if(glow && glow.embed.Flash.version().major > 0)
	{
		var hasflash = true;
	}
	else
...
var v18arr = ((document.location.pathname+"/").replace('//','/')).split('/');
v18arr.shift();
v18arr.shift();
s.eVar18 = "/" + v18arr.join('/');
...
function s_doPlugins(s) {
	...
	if ("undefined" != typeof ws &&
        "undefined" != typeof ws.siteCatalyst) {
        s.eVar32 = "ws::"+ws.siteCatalyst.adKeyword;
		...
		if(s.prop4 != 'undefined' && docType == "INDEX" && hasflash){
			
		}else if(s.prop4 != 'undefined' && (docType == "STORY-VIDEO" || docType == "VIDEO") && hasflash){
			s.prop26 = "ws::v::"+ws.siteCatalyst.storyId;
			s.eVar31 = "video-flash";
		}else if (s.prop4 != 'undefined' && (docType == "STORY-AUDIO" || docType == "AUDIO") && hasflash) {
			s.prop26 = s.eVar23="ws::a::"+ws.siteCatalyst.storyId;
			s.eVar31 = "audio-flash";
		}else if(s.prop4 != 'undefined'){
			s.prop26 = s.eVar23="ws::v::"+ws.siteCatalyst.storyId;
			s.eVar31 = "video-html5";
		}else{
			s.eVar31 = "page";
		}
		
		s.eVar31 = "ws::"+s.eVar31;
		s.eVar5 = "ws::"+s.prop5;
		
		s.eVar10 = ws.siteCatalyst.firstpublished;
		...
		s.prop15 = ws.siteCatalyst.uri;
		if(s.prop15.length > 99){
			s.prop15 = s.prop25+("-too long");
		}
		
		s.eVar15 = ws.siteCatalyst.uri;
		if(s.eVar15.length > 254){
			s.eVar15 = s.prop25+("-too long");
		}		
		...
		s.prop55 = "worldservice";
		s.eVar55 = "D=c55";
		
		if(ws.siteCatalyst.publishdate){
			s.eVar10 = ws.siteCatalyst.publishdate;
		}
...
if(hasflash){s.Media.playerName="EMP";}else{s.Media.playerName="HTML5";}
s.Media.trackWhilePlaying=true;
s.Media.trackUsingContextData = true;
s.Media.trackVars="eVar21,eVar22,eVar23,eVar24,eVar26,eVar31,eVar55,events,prop21,prop26,eVar27,";
s.Media.trackEvents = "event4,event5,event12,event13,event14,event11,event7,event26,event27";
s.Media.contextDataMapping = {
	  "a.media.name":"eVar21,prop21",
	  "a.media.segment":"eVar27",
	  "a.contentType":"eVar22",
	...
	if(1==1){ //just so i can turn it on and off as required.
		...
		switch(obj.mediaEvent){
			...
			case "contentEnd":  //Executes when the player initialises.
				s.setMediaProperties(obj);
                s.Media.stop(obj.mediaName, obj.mediaLength);
